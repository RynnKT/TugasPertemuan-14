...
@NamedQueries({
    ...
    @NamedQuery(name = "Akun.findByKodeUnik", query = "SELECT a FROM Akun a WHERE a.kodeUnik = :kodeUnik")})
public class Akun implements Serializable {
    ...
    public Akun(String username, String password, String kodeUnik) {
        this.username = username;
    ...
    public String toString() {
        return "pertemuan_13.Akun[ username=" + username + " ]";
    }
